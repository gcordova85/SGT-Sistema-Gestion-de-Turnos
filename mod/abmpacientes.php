        ...
        <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-8 offset-md-1">
                    <button type="button" id="botonNuevo" class="btn btn-abm"><a href="paciente.html">Nuevo</a> </button>
                    ...
                    <div class="table-responsive">
                        <table id="user_data" class="table table-bordered table-condensed">
                            <tr>
                                ...
                                <th class="navbar" width="10%">Direccion</th>
                                <th class="navbar" width="10%">Telefono</th>
                                <th class="navbar" width="10%">Persona a Cargo</th>
                                <th class="navbar" width="10%">Datos de emergencia</th>
                                <th class="navbar" width="10%">Obra social</th>
                                <th class="navbar" width="10%">Certificado</th>
                                <th class="navbar" width="10%">Autorizacion</th>
                            ...
                            <tr>
                                ...
                                <td>certificado1</td>
                                <td>autorizacion1</td>
                                <td><button type="button" id="botonNuevo" class="btn btn-abm"> <a href="paciente.html">Ver mas...</a></button></td>
                            </tr>
                            <tr>
                                <td>1</td>
                                <td>Juan</td>
