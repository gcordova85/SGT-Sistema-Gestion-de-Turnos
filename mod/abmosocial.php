        ...
        <div class="container">
            ...
            <div class="row" id="fila-botones">
                ...
                <div class="col-xs-5 text-right">
                    <button type="button" id="botonNuevo" class="btn btn-barra" data-toggle="modal" data-target="#modalOsociales" style="margin: 10px">Nuevo</button>
                </div>
                                ...
                                <div class="row oculto">
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div id="div-nOsocial" class="form-group">
                                            <label for="nOsocial" class="control-label col-form-label">N° Obra social:</label>
