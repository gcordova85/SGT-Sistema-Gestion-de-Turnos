...
<div class="container">
    ...
    <!-- ELEMENTOS EXTRAS -->
        ...
        <div id="btnAsignarDps"class="col-xs-offset-4 col-sm-offset-4 col-md-offset-4">
            <a href="abmTurnos.php"> <button class="btn btn-success">Asignar Turno</button></a>
        </div>

</div>
  <!-- FIN ELEMENTOS EXTRAS -->
    <?php
